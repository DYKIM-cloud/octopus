...
class Logger(object):
    ...
    def _setStreamHandler(self, formatter_string):
        ...
        ch.setLevel(self.myLogger.level)
    ...
    def _setFileHandler(self, formatter_string, total_path):
        ...
        """
        formatter = logging.Formatter(formatter_string)
        total_file_handler = logging.FileHandler(filename=total_path, encoding='utf-8')
    ...
    def debug(self, user_name, debug_msg="debug!"):
        """
        write information log message in total.log with debug message and show command
    ...
    def info(self, user_name, info_msg="info!"):
        """
        write information log message in total.log with info message and show command
...
class JobLogger(Logger):
    ...
    def __init__(self, platform_name, log_level):
        ...
        if not os.path.isdir(TOTAL_LOG_FOLDER):
