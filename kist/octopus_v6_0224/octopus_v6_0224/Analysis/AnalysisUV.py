...
def  calculateUV_Data(uv_dict, reference_dict, WavelengthMin=440, WavelengthMax=849, BoxCarSize=10, Prominence=0.01, PeakWidth=20):
    '''
    Anaylsis multi-Peak properties
...
def  calculateManualUV_Data(uv_dict, WavelengthMin=440, WavelengthMax=849, BoxCarSize=10, Prominence=0.01, PeakWidth=20):
    '''
    Anaylsis multi-Peak properties
...
if __name__ == "__main__":
    ...
    with open('Analysis\\test.json','r') as file:
        testspectrum = json.load(file)
    ...
    #plt.plot(testspectrum['Wavelength'],testspectrum['RawSpectrum'])
    #plt.show()
    uv_result, calc_result = calculatePL_Data(testspectrum, WavelengthMin=410, WavelengthMax=700, BoxCarSize=10, Prominence=0.01, PeakWidth=15)
