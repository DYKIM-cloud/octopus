...
class QEPro2192(OceanOpticsSpectrometer):
    ...
    #     with open("Hardware\\UV\\reference.json", "r") as reference_data:
    #         reference_dict = json.load(reference_data)
    ...
    def obtain_reference_spectrum(self) -> UVSpectrum:
        ...
        self.reference["RawSpectrum"] = intensities
        self.__ref_called = True
    ...
    def obtain_spectrum(self) -> UVSpectrum:
        ...
        wavelengths, intensities = self.scan()
        spec_dict = {}
        spec_dict["Wavelength"] = wavelengths
        spec_dict["RawSpectrum"] = intensities
        return spec_dict
