...
if __name__ == "__main__":
    ## INPUT(실험값)
    params =[{'AddSolution=A_Injectionrate': 50.0, 'AddSolution=B_Injectionrate': 50.0, 'AddSolution=C_Injectionrate': 50.0, 'Heat=Temperature':260.0}]
    ## OUTPUT(실험값)
    data_dict=load_result(path = "InPZnSe_flow\\260C_1800s.txt")
    ## path
    job_script_path="InPZnSe.json"
    load_model_path="./model_InPZnSe10.pkl"  # 반드시 다른이름으로 할 것
    save_model_path = "./model_InPZnSe11.pkl"  # 반드시 다른이름으로 할 것 - 덮어쓰고나면 복구를 못해요.
