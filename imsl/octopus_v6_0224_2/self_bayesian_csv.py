...
if __name__ == "__main__":
    ...
    ## OUTPUT(실험값)
    path = "2508optimize\\spectra_with_params.csv"
    ...
    load_model_path = "1022core_3.pickle"  # 반드시 다른이름으로 할 것
    save_model_path = "1022core_3.pickle"  # 반드시 다른이름으로 할 것 - 덮어쓰고나면 복구를 못해요.
